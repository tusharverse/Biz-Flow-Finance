    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="flex-1 flex items-center">
        <div className="container mx-auto px-4 md
          <div className="flex-1 space-y-6 mb-8 md
            ...
            <div className="flex flex-col sm
              <Link to="/register">
                <Button size="lg" className="w-full sm
                  Get Started - It's Free
                </Button>
              </Link>
              <Button variant="outline" size="lg" className="w-full sm
                Learn More
              </Button>
            </div>
      ...
      <footer className="bg-card py-8 border-t">
        <div className="container mx-auto px-4 md
          <div className="flex flex-col md
            ...
            <div className="flex flex-col md
              <Link to="/login" className="text-sm text-muted-foreground hover
                Login
              </Link>
              <Link to="/register" className="text-sm text-muted-foreground hover
                Sign Up
              </Link>
              <a href="#" className="text-sm text-muted-foreground hover
                Privacy Policy
              </a>
              <a href="#" className="text-sm text-muted-foreground hover
                Terms of Service
