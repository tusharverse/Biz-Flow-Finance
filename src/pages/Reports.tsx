...
const Reports = () => {
  ...
  const getMetricsPercentage = (value: number, total: number) => {
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="border border-border rounded-lg p-4 cursor-pointer hover:bg-accent transition-colors">
