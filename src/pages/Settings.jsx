    ...
    <div className="flex h-screen bg-background">
                  ...
                  <div>
                    ...
                    <div className="relative mt-2">
                      ...
                      <button
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover
                      >
                    ...
                    <div className="p-4 border border-border rounded-lg">
                      ...
                      <div className="flex gap-3">
                        <button 
                          ...
                          className={cn(
                            "w-10 h-10 rounded-lg bg-blue-500 hover
                        ...
                        <button 
                          ...
                          className={cn(
                            "w-10 h-10 rounded-lg bg-green-500 hover
                        ...
                        <button 
                          ...
                          className={cn(
                            "w-10 h-10 rounded-lg bg-purple-500 hover
                        ...
                        <button 
                          ...
                          className={cn(
                            "w-10 h-10 rounded-lg bg-orange-500 hover
      ...
      <AlertDialog open={showLogoutDialog} onOpenChange={setShowLogoutDialog}>
        <AlertDialogContent>
          ...
          <AlertDialogAction onClick={handleLogout} className="bg-destructive hover
            Yes, Logout
          </AlertDialogAction>
        </AlertDialogContent>
      </AlertDialog>
